...
import {CollaboratorFormProps, FormCollaboratorData} from "@/types/component/form/form";

const CollaboratorForm: React.FC<CollaboratorFormProps> = ({ isEditing, onClose, onSubmit }) => {
