...
>("admin/users/getUsers", async ({ page, size }, { rejectWithValue }) => {
  try {
...
export const getAdmins = createAsyncThunk<
  ...
  { page: number; size: number },
  { rejectValue: ErrorResponseProps }
>("admin/admins/getAdmins", async ({ page, size }, { rejectWithValue }) => {
  try {
    const response = await axiosInstance.get(
      `/admin/admins?page=${page}&size=${size}`
    );
    if (response.data.code === 2000) {
      const data = response.data.result.data;
      return {
...
export const createUser = createAsyncThunk<
  ...
  { rejectValue: ErrorResponseProps }
>("admin/user/createUser", async (userData, { rejectWithValue }) => {
  try {
...
export const createAdmin = createAsyncThunk<
  ...
  Omit<User, "id" | "role" | "dateJoined" | "totalSpent">,
  { rejectValue: ErrorResponseProps }
>("admin/admin/createAdmin", async (userData, { rejectWithValue }) => {
  try {
...
export const updateUser = createAsyncThunk<
  ...
  { rejectValue: ErrorResponseProps }
>("admin/user/updateUser", async ({ id, userData }, { rejectWithValue }) => {
  try {
...
export const deleteUser = createAsyncThunk<
  ...
  string,
  { rejectValue: ErrorResponseProps }
>("admin/user/deleteUser", async (id, { rejectWithValue }) => {
  try {
...
export const deleteUsers = createAsyncThunk<
  ...
  string[],
  { rejectValue: ErrorResponseProps }
>("admin/users/deleteUsers", async (userIds, { rejectWithValue }) => {
  try {
...
export const getMyInfo = createAsyncThunk<
  ...
  void,
  { rejectValue: ErrorResponseProps }
>("my-info", async (_, { rejectWithValue }) => {
  try {
...
export const updateMyInfo = createAsyncThunk<
  ...
  { rejectValue: ErrorResponseProps }
>("update-info", async (userData, { rejectWithValue }) => {
  try {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(deleteUsers.rejected, (state, action) => {
        ...
        state.error = action.payload || {
          code: -1,
          message: "Xóa các Người dùng thất bại.",
        };
      })
      // Get My Info
      ...
      .addCase(getMyInfo.rejected, (state, action) => {
        ...
        state.error = action.payload || {
          code: -1,
          message: "Xem thông tin bản thân thất bại.",
        };
      })
      // Update My Info
      ...
      .addCase(updateMyInfo.rejected, (state, action) => {
        ...
        state.error = action.payload || {
          code: -1,
          message: "Cập nhật thông tin bản thân thất bại.",
        };
      });
  },
});
