...
>("admin/products/getProducts", async ({ page, size }, { rejectWithValue }) => {
  try {
...
export const createProduct = createAsyncThunk<
  ...
  FormData,
  { rejectValue: ErrorResponseProps }
>("admin/product/createProduct", async (formData, { rejectWithValue }) => {
  try {
...
export const deleteProduct = createAsyncThunk<
  ...
  string,
  { rejectValue: ErrorResponseProps }
>("admin/product/deleteProduct", async (id, { rejectWithValue }) => {
  try {
...
export const deleteProducts = createAsyncThunk<
  ...
  string[],
  { rejectValue: ErrorResponseProps }
>("admin/products/deleteProducts", async (productIds, { rejectWithValue }) => {
  try {
    ...
    builder
      ...
      .addCase(getProducts.fulfilled, (state, action) => {
        ...
        state.products = action.payload.content.map((product) => {
          ...
          if (product.originalImageName) {
            const tinyImageName = product.originalImageName.replace(
              "original_",
              "tiny_"
            );
      ...
      .addCase(createProduct.fulfilled, (state, action) => {
        ...
        if (action.payload.originalImageName) {
          const tinyImageName = action.payload.originalImageName.replace(
            "original_",
            "tiny_"
          );
      ...
      .addCase(updateProduct.fulfilled, (state, action) => {
        ...
        if (updatedProduct.originalImageName) {
          const tinyImageName = updatedProduct.originalImageName.replace(
            "original_",
            "tiny_"
          );
